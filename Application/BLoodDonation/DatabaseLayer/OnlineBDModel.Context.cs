...
namespace DatabaseLayer
{
    ...
    public partial class AA_BDEntities : DbContext
    {
        public AA_BDEntities()
            : base("name=AA_BDEntities")
        {
        }
        ...
        public virtual DbSet<BloodStockDetail> BloodStockDetails { get; set; }
